(function () {
  ...
  // CHANGE #92
  // ------------------------------------------------------------
  // Stable navigation package:
  // - Services and Solutions now have direct links AND dropdowns
  // - Fixed invalid markup that blocked direct navigation
  // - Improved spacing to avoid text collisions
  // - CRM remains untouched
  // - Existing language handling preserved
  // ============================================================
